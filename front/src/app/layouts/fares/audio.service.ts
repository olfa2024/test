...
import {Audio} from "./faresaudio.modal";// Assurez-vous d'importer correctement le modèle Audio

@Injectable({
  providedIn: 'root'
})
export class AudioService {
  private apiUrl = 'http://localhost:8080/api/audio/fares'; // Remplacez ceci par l'URL de votre backend
